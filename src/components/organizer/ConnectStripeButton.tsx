...
export default function ConnectStripeButton() {
  ...
  return <div className="action-box"><button className="button button-primary" disabled={loading} aria-busy={loading} onClick={connect}>{loading ? "Stripeへ接続中…" : "Stripe Connect を設定"}</button>{message && <p>{message}</p>}</div>
}
