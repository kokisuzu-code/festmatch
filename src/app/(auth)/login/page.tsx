  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="bg-slate-800 rounded-2xl shadow-sm border border-slate-700 w-full max-w-md p-8">
        ...
        <h2 className="text-xl font-semibold text-slate-100 mb-6">ログイン</h2>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-slate-800 px-3 text-slate-400">または</span>
          </div>
        </div>

        <button
          onClick={handleGoogleLogin}
          className="w-full flex items-center justify-center gap-3 border border-slate-600 rounded-lg px-4 py-2.5 text-sm font-medium text-slate-200 hover:bg-slate-700 transition-colors"
        >
        ...
        <p className="text-center text-sm text-slate-400 mt-6">
          アカウントをお持ちでない方は{' '}
          <Link href="/signup" className="text-green-400 font-medium hover:underline">
            新規登録
          </Link>
        </p>
      </div>
